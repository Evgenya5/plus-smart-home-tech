...
import ru.yandex.practicum.smarthome.telemetry.collector.model.hub.event.*;
import ru.yandex.practicum.smarthome.telemetry.collector.model.sensor.event.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import ru.yandex.practicum.kafka.telemetry.event.*;
import ru.yandex.practicum.smarthome.telemetry.collector.kafka.KafkaAvroProducer;
